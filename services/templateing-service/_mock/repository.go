...
// Source: github.com/hingew/hsfl-master-ai-cloud-engineering/templating-service/templates/repository (interfaces: IRepository)
...
func (m *MockIRepository) CreateTemplate(arg0 model.PdfTemplate) (*uint, error) {
        m.ctrl.T.Helper()
...
func (m *MockIRepository) DeleteTemplate(arg0 uint) error {
        m.ctrl.T.Helper()
...
func (m *MockIRepository) GetTemplateById(arg0 uint) (*model.PdfTemplate, error) {
        m.ctrl.T.Helper()
...
func (mr *MockIRepositoryMockRecorder) GetTemplateById(arg0 interface{}) *gomock.Call {
        mr.mock.ctrl.T.Helper()
        return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTemplateById", reflect.TypeOf((*MockIRepository)(nil).GetTemplateById), arg0)
}

// UpdateTemplate mocks base method.
func (m *MockIRepository) UpdateTemplate(arg0 uint, arg1 model.PdfTemplate) error {
        m.ctrl.T.Helper()
