...
func (m *MockController) GetTemplateWithCoalecing(arg0 http.ResponseWriter, arg1 *http.Request) {
        m.ctrl.T.Helper()
...
func (mr *MockControllerMockRecorder) GetTemplateWithCoalecing(arg0, arg1 interface{}) *gomock.Call {
        mr.mock.ctrl.T.Helper()
        return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTemplateWithCoalecing", reflect.TypeOf((*MockController)(nil).GetTemplateWithCoalecing), arg0, arg1)
}
